...
- 👥 **Система ролей** — разделение прав (User, CoworkAdmin, SystemAdmin)
...
- 🤖 **Интеграция с ИИ** — прогнозирование цен и загруженности коворкинга (Gemini AI)
- 🔒 **Защита эндпоинтов** — JWT middleware и проверка ролей
- 📝 **Журнал аудита** — логирование важных действий менеджеров
...
| `GET/POST/PUT/DELETE` | `/api/workspaces` | Управление местами (только `cowork_admin`) |
| `GET/POST/PUT/DELETE` | `/api/tariffs` | Управление тарифами (только `cowork_admin`) |
| `GET/PUT` | `/api/admin/...` | Управление пользователями (только `system_admin`) |
| `GET` | `/api/auditlogs` | Просмотр логов (только администраторы) |
| `GET` | `/api/predictions/workload?day=monday` | Прогноз загруженности от ИИ (только авторизованные) |
...
- [x] Система ролей (Пользователь / Админ коворкинга / Системный администратор)
- [x] Интеграция с Gemini API для прогнозирования загруженности
...
>>>>>>> b4d8ccdfcf00d3f6b4faba911535124601f854d1
