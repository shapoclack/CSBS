...
Опирайся на эти данные при ответах. Если загрузка на запрошенный день больше 75%%, предупреди, что мест мало и цена может быть повышена на 10-20%%. Если меньше 45%% — предложи скидку 10-20%%. Во всех остальных случаях цена стандартная. Отвечай кратко, вежливо и по делу.
Важно: не здоровайся в ответах (никаких «Здравствуйте», «Привет», «Добрый день» и подобных приветствий) — сразу переходи к сути ответа.`, formattedWorkload)
